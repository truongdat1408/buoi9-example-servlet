...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                                    ...
                                    <tbody>
                                        <c:forEach items="${roles}" var="item">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-primary edit-btn">Sửa</a>
                                                    <a href="#" class="btn btn-sm btn-danger del-btn" id="${item.getId()}">Xóa</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2023 &copy; Truong Dat </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
